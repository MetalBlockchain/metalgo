...
echo "Building docker image based off of most recent local commits of metalgo and coreth"

AVALANCHE_REMOTE="git@github.com:MetalBlockchain/metalgo.git"
...
AVALANCHE_CLONE="$WORKPREFIX/metalgo"
...
AVALANCHE_COMMIT_HASH="$(git -C "$EXISTING_GOPATH/$AVA_LABS_RELATIVE_PATH/metalgo" rev-parse --short HEAD)"
