...
# DOCKER_IMAGE=mymetalgo ./scripts/build_image.sh                # Build local single arch image with a custom image name
# DOCKER_IMAGE=MetalBlockchain/metalgo ./scripts/build_image.sh      # Build and push multi-arch image to docker hub
# DOCKER_IMAGE=localhost:5001/metalgo ./scripts/build_image.sh   # Build and push multi-arch image to private registry
# DOCKER_IMAGE=localhost:5001/mymetalgo ./scripts/build_image.sh # Build and push multi-arch image to private registry with a custom image name
