...
//
//	mockgen -package=snowmantest -destination=snow/consensus/snowman/snowmantest/mock_block.go github.com/MetalBlockchain/metalgo/snow/consensus/snowman Block
//
