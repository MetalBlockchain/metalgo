...
//
//	mockgen -package=validatorsmock -destination=snow/validators/validatorsmock/subnet_connector.go -mock_names=SubnetConnector=SubnetConnector github.com/MetalBlockchain/metalgo/snow/validators SubnetConnector
//
