...
require (
	...
	github.com/MetalBlockchain/metalgo/graft/coreth v1.14.2
	github.com/MetalBlockchain/metalgo/graft/subnet-evm v1.14.2
	github.com/StephenButtolph/canoto v0.18.0
	github.com/antithesishq/antithesis-sdk-go v0.3.8
	// NOTE(metal): libevm intentionally stays on the upstream ava-labs module
	// path in this merge: MetalBlockchain/libevm is a pure module-path rename
	// with no tag for the 0.4.0 line yet, and a renamed fork cannot be swapped
	// in via replace (module self-imports). Once Metallicus tags
	// MetalBlockchain/libevm v1.13.14-0.4.0.rc.2-<ts>, a mechanical rename
	// restores the fork convention.
...
require (
	github.com/MetalBlockchain/metalgo/graft/evm v1.14.2 // indirect
...
replace github.com/MetalBlockchain/metalgo/graft/coreth => ./graft/coreth

replace github.com/MetalBlockchain/metalgo/graft/subnet-evm => ./graft/subnet-evm

replace github.com/MetalBlockchain/metalgo/graft/evm => ./graft/evm
