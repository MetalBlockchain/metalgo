...
|--------|------|---------|-------------|
| avalanchego | `/` (root) | BSD-3 | `github.com/MetalBlockchain/metalgo` |
| coreth | `graft/coreth/` | LGPL-3 | `github.com/MetalBlockchain/metalgo/graft/coreth` |
| evm | `graft/evm/` | - | `github.com/MetalBlockchain/metalgo/graft/evm` |
| subnet-evm | `graft/subnet-evm/` | LGPL-3 | `github.com/MetalBlockchain/metalgo/graft/subnet-evm` |
...
x_defs = {
    # keep
    "github.com/MetalBlockchain/metalgo/version.GitCommit": "{STABLE_GIT_COMMIT}",
},
```
...
# gazelle:prefix github.com/MetalBlockchain/metalgo/graft/coreth
```
...
2. **Create the module's root BUILD.bazel** with the gazelle prefix:
   ...
   # gazelle:prefix github.com/MetalBlockchain/metalgo/graft/newmodule
   ```
