...
| Module | Import Path |
|--------|-------------|
| Main | `github.com/MetalBlockchain/metalgo` |
| Coreth | `github.com/MetalBlockchain/metalgo/graft/coreth` |
| EVM | `github.com/MetalBlockchain/metalgo/graft/evm` |
| Subnet-EVM | `github.com/MetalBlockchain/metalgo/graft/subnet-evm` |
...
```bash
go get github.com/MetalBlockchain/metalgo@v1.15.0
```
...
github.com/MetalBlockchain/metalgo v1.15.0
github.com/MetalBlockchain/metalgo/graft/coreth v1.15.0
github.com/MetalBlockchain/metalgo/graft/evm v1.15.0
github.com/MetalBlockchain/metalgo/graft/subnet-evm v1.15.0
```
...
```bash
go get github.com/MetalBlockchain/metalgo@v0.0.0-myfeature
```
...
```go
replace (
    github.com/MetalBlockchain/metalgo => /path/to/avalanchego
    github.com/MetalBlockchain/metalgo/graft/coreth => /path/to/avalanchego/graft/coreth
    github.com/MetalBlockchain/metalgo/graft/evm => /path/to/avalanchego/graft/evm
    github.com/MetalBlockchain/metalgo/graft/subnet-evm => /path/to/avalanchego/graft/subnet-evm
)
```
...
When you run `go get github.com/MetalBlockchain/metalgo@abc123`, Go
...
tagged versions (e.g., `require github.com/MetalBlockchain/metalgo v1.14.0`).
