...
import (
	...
	"github.com/MetalBlockchain/metalgo/vms/saevm/params"
)

// Clock is a mutable, test-controlled clock used to drive the block-building and
// consensus time of a [github.com/MetalBlockchain/metalgo/vms/saevm/sae.VM] and the
...
// [github.com/MetalBlockchain/metalgo/vms/saevm/blocks.Block] that
