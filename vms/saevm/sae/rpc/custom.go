...
// - https://github.com/MetalBlockchain/metalgo/blob/v1.14.1/graft/coreth/internal/ethapi/api_extra.go
// - https://github.com/MetalBlockchain/metalgo/blob/v1.14.1/graft/coreth/internal/ethapi/api.coreth.go
...
func (c *customSubscriptionAPI) NewAcceptedTransactions(ctx context.Context, fullTx *bool) (*rpc.Subscription, error) {
	...
	// See https://github.com/MetalBlockchain/libevm/blob/3d7f8934ee6c/event/feedof.go#L49-L50
