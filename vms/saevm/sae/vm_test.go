...
import (
	...
	"github.com/MetalBlockchain/libevm/core/txpool/legacypool"
	...
	"github.com/MetalBlockchain/metalgo/vms/saevm/blocks/blockstest"
	"github.com/MetalBlockchain/metalgo/vms/saevm/cmputils"
	"github.com/MetalBlockchain/metalgo/vms/saevm/gastime"
	"github.com/MetalBlockchain/metalgo/vms/saevm/hook"
	"github.com/MetalBlockchain/metalgo/vms/saevm/hook/hookstest"
	"github.com/MetalBlockchain/metalgo/vms/saevm/saedb"
	"github.com/MetalBlockchain/metalgo/vms/saevm/saetest"
	"github.com/MetalBlockchain/metalgo/vms/saevm/saetest/escrow"
	"github.com/MetalBlockchain/metalgo/vms/saevm/txgossip/txgossiptest"

	snowcommon "github.com/MetalBlockchain/metalgo/snow/engine/common"
	saeparams "github.com/MetalBlockchain/metalgo/vms/saevm/params"
	saerpc "github.com/MetalBlockchain/metalgo/vms/saevm/sae/rpc"
	saetypes "github.com/MetalBlockchain/metalgo/vms/saevm/types"
	libevmhookstest "github.com/MetalBlockchain/libevm/libevm/hookstest"
)
...
func TestSnapshotGenerationSpansDiskLayerMoves(t *testing.T) {
	...
	// https://github.com/MetalBlockchain/libevm/blob/80edd419ae21fa745accad9f528a190b1f81c7c7/core/state/snapshot/snapshot.go#L396-L398
	const numBlocks = 8 + 1
	for range numBlocks {
		b := sut.runConsensusLoop(t, sut.wallet.SetNonceAndSign(t, 0, &types.DynamicFeeTx{
			To:        &common.Address{},
