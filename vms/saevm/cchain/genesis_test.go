...
import (
	...
	avalanchegenesis "github.com/MetalBlockchain/metalgo/genesis"
	corethparams "github.com/MetalBlockchain/metalgo/graft/coreth/params"
	evmutils "github.com/MetalBlockchain/metalgo/graft/evm/utils"
...
func TestParseGenesis(t *testing.T) {
	...
	var (
		...
		fujiCtx    = &snow.Context{NetworkUpgrades: upgrade.Tahoe}
	...
	tests := []struct {
		...
		},
		{
			name:    "tahoe",
			ctx:     fujiCtx,
			genesis: avalanchegenesis.TahoeConfig.CChainGenesis,
			want: &core.Genesis{
				Config: corethparams.WithExtra(
					&corethparams.ChainConfig{
						ChainID:             fujiChainID,
...
func TestWriteGenesis(t *testing.T) {
	...
	var (
		...
		fujiGenesis  = avalanchegenesis.TahoeConfig.CChainGenesis
	)
	type spec struct {
