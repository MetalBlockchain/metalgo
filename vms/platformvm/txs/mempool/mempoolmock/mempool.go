...
func (m *Mempool) RequestBuildBlock(emptyBlockPermitted bool) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "RequestBuildBlock", emptyBlockPermitted)
}

// RequestBuildBlock indicates an expected call of RequestBuildBlock.
func (mr *MempoolMockRecorder) RequestBuildBlock(emptyBlockPermitted any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RequestBuildBlock", reflect.TypeOf((*Mempool)(nil).RequestBuildBlock), emptyBlockPermitted)
}
