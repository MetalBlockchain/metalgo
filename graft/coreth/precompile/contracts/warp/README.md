...
For more details on Avalanche Warp Messaging, see the AvalancheGo [Warp README](https://github.com/MetalBlockchain/metalgo/blob/master/vms/platformvm/warp/README.md).
...
The actual `message` is the entire [Avalanche Warp Unsigned Message](https://github.com/MetalBlockchain/metalgo/blob/master/vms/platformvm/warp/unsigned_message.go#L14) including an [AddressedCall](https://github.com/MetalBlockchain/metalgo/tree/master/vms/platformvm/warp/payload#addressedcall). The unsigned message is emitted as the unindexed data in the log.
...
Avalanche Warp Messages are encoded as a signed Avalanche [Warp Message](https://github.com/MetalBlockchain/metalgo/blob/master/vms/platformvm/warp/message.go) where the [UnsignedMessage](https://github.com/MetalBlockchain/metalgo/blob/master/vms/platformvm/warp/unsigned_message.go)'s payload includes an [AddressedPayload](https://github.com/MetalBlockchain/metalgo/blob/master/vms/platformvm/warp/payload/payload.go).
...
Therefore, we use the [`predicate`](https://github.com/MetalBlockchain/metalgo/tree/master/vms/evm/predicate) package to encode the actual byte slice of size N into the access list.
