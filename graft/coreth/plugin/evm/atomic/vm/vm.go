...
func (vm *VM) Initialize(
	...
	// NOTE(metal): Metal networks have no Avalanche bonus-block/extDataHash
	// history, so the mainnet/fuji extDataHashes wiring is intentionally
	// removed (matches MetalBlockchain/coreth).
