...
Atomic transactions utilize Shared Memory (documented in the [atomic chains README](https://github.com/MetalBlockchain/metalgo/blob/master/chains/atomic/README.md)) to send assets to the P-Chain and X-Chain.
