...
# Example: rewrite-imports.sh github.com/MetalBlockchain/coreth
#   Will rewrite: github.com/MetalBlockchain/coreth -> github.com/MetalBlockchain/metalgo/graft/coreth
# Example: rewrite-imports.sh github.com/MetalBlockchain/coreth github.com/MetalBlockchain/metalgo/coreth
#   Will rewrite: github.com/MetalBlockchain/coreth -> github.com/MetalBlockchain/metalgo/coreth
#

if [ $# -lt 1 ] || [ $# -gt 2 ]; then
  echo "Error: one or two arguments required"
  echo "Usage: $0 <original-module-import-path> [new-module-import-path]"
  echo "Example: $0 github.com/MetalBlockchain/coreth"
  echo "Example: $0 github.com/MetalBlockchain/coreth github.com/MetalBlockchain/metalgo/coreth"
  exit 1
fi
...
# e.g., github.com/MetalBlockchain/coreth -> coreth
...
if [ $# -eq 2 ]; then
  ...
  TARGET_IMPORT="github.com/MetalBlockchain/metalgo/graft/${PACKAGE_NAME}"
fi
