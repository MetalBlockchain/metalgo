...
# Example: subtree-merge.sh github.com/MetalBlockchain/coreth
# Example: subtree-merge.sh github.com/MetalBlockchain/coreth 1a498175
# Example: subtree-merge.sh github.com/MetalBlockchain/coreth master evm
#
# Arguments:
#   module-path: The Go module path (e.g., github.com/MetalBlockchain/coreth)
...
if [ $# -lt 1 ] || [ $# -gt 3 ]; then
  ...
  echo "Example: $0 github.com/MetalBlockchain/coreth" >&2
  echo "Example: $0 github.com/MetalBlockchain/coreth 1a498175" >&2
  echo "Example: $0 github.com/MetalBlockchain/coreth master evm" >&2
  exit 1
fi
...
if [ $# -eq 3 ]; then
  ...
  # Example: github.com/MetalBlockchain/coreth -> coreth
