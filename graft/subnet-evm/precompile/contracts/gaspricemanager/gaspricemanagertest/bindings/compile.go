...
//go:generate go run github.com/MetalBlockchain/libevm/cmd/abigen --pkg bindings --type IGasPriceManager --abi ../../IGasPriceManager.abi --out gen_igaspricemanager_binding.go
...
//go:generate sh -c "sed -i.bak -e 's|github.com/MetalBlockchain/libevm/accounts/abi/bind|github.com/MetalBlockchain/metalgo/graft/subnet-evm/accounts/abi/bind|g' gen_igaspricemanager_binding.go && rm -f gen_igaspricemanager_binding.go.bak"
