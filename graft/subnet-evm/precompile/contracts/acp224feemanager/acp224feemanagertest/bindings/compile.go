...
//go:generate sh -c "sed -i.bak -e 's|github.com/ava-labs/libevm/accounts/abi/bind|github.com/MetalBlockchain/metalgo/graft/subnet-evm/accounts/abi/bind|g' gen_iacp224feemanager_binding.go && rm -f gen_iacp224feemanager_binding.go.bak"
