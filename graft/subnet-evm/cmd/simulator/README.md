...
```bash
cd $GOPATH/src/github.com/MetalBlockchain/metalgo/graft/subnet-evm/cmd/simulator
```
...
To start a single node network, follow the instructions from the AvalancheGo [README](https://github.com/MetalBlockchain/metalgo#building-avalanchego) to build from source.
