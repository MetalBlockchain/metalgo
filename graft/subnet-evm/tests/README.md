...
the [tmpnet
fixture](https://github.com/MetalBlockchain/metalgo/blob/master/tests/fixture/tmpnet/README.md). By
...
[documentation](https://github.com/MetalBlockchain/metalgo/blob/master/tests/fixture/tmpnet/README.md#Monitoring)
applies.
