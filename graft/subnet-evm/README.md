...
Subnet EVM is the [Virtual Machine (VM)](https://build.avax.network/docs/quick-start/virtual-machines) that defines the Subnet Contract Chains. Subnet EVM is a simplified version of [Coreth VM (C-Chain)](https://github.com/MetalBlockchain/coreth).
...
Subnet EVM is a simplified version of [Coreth VM (C-Chain)](https://github.com/MetalBlockchain/coreth).
