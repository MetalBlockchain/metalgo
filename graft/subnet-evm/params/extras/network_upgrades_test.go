	...
	testcases := []struct {
	...
	}{
		{
			...
			upgrades1: &NetworkUpgrades{
				...
				DurangoTimestamp:   avalancheutils.PointerTo[uint64](2),
			},
			upgrades2: &NetworkUpgrades{
				SubnetEVMTimestamp: avalancheutils.PointerTo[uint64](1),
				DurangoTimestamp:   avalancheutils.PointerTo[uint64](2),
		...
		},
		{
			...
			upgrades2: &NetworkUpgrades{
				SubnetEVMTimestamp: avalancheutils.PointerTo[uint64](1),
				DurangoTimestamp:   avalancheutils.PointerTo[uint64](3),
			},
			expected: false,
		},
		{
...
func TestCheckNetworkUpgradesCompatible(t *testing.T) {
	testcases := []struct {
		...
		},
		{
			...
			upgrades2: &NetworkUpgrades{
				SubnetEVMTimestamp: avalancheutils.PointerTo[uint64](1),
				DurangoTimestamp:   avalancheutils.PointerTo[uint64](1),
			},
			time:  1,
			valid: false,
		},
...
func TestVerifyNetworkUpgrades(t *testing.T) {
	testcases := []struct {
		...
		{
			name: "Invalid_Mainnet_Durango_reconfigured_to_Tahoe",
			upgrades: &NetworkUpgrades{
				SubnetEVMTimestamp: avalancheutils.PointerTo[uint64](0),
		...
		{
			name: "Valid_Tahoe_Durango_reconfigured_to_Mainnet",
			upgrades: &NetworkUpgrades{
				SubnetEVMTimestamp: avalancheutils.PointerTo[uint64](0),
