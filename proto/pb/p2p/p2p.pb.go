...
// ref. "metalgo/network/peer#handleVersion"
// ref. https://pkg.go.dev/github.com/MetalBlockchain/metalgo/network#Network "Dispatch"
type Version struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
// validators.
// ref. "metalgo/network/network#Dispatch.runtTimers"
//
...
// (see "metalgo/snow/engine/common/bootstrapper.Startup").
...
//
// See "metalgo/snow/engine/common/bootstrapper.Startup" and "sendGetAccepted".
// See "snow/engine/common/bootstrapper.go#AcceptedFrontier".
...
// See "metalgo/snow/engine/common#SendMixedQuery".
//
